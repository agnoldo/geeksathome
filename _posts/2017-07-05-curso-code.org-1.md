---
layout: post
title: "Curso Code.org #1: crianças de 05 a 07 anos começando a ler"
date: 2017-07-05 11:35:47
description: "Os alunos vão criar programas de computador, desenvolvendo capacidades de trabalho em grupo, resolução de problemas e persistência."
main-class: 'codeorg'
color: '#7D669E'
tags:
- code.org
...
categories:
- "Code.org - Curso 1"
twitter_text: "Code.org Curso 1: crianças de 05 a 07 anos ainda não totalmente alfabetizadas"
introduction: "Os alunos vão criar programas de computador, desenvolvendo capacidades de trabalho em grupo, resolução de problemas e persistência."
---
...
Os alunos vão criar programas de computador, o que os ajudará a aprender a colaborar com outras pessoas, desenvolver habilidades de resolução de problemas e persistir na execução de tarefas difíceis. No final do curso, os estudantes criam seu próprio jogo ou história personalizados que eles podem compartilhar com outras pessoas. Este curso é recomendado para crianças da pré-escola até o 1º ano.
